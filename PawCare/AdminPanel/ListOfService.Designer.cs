namespace PawCare.AdminPanel
{
    partial class ListOfService
    {
        ...
        private void InitializeComponent()
        {
            ...
            ServiceTableData = new DataGridView();
            ((System.ComponentModel.ISupportInitialize)ServiceTableData).BeginInit();
            SuspendLayout();
            // 
            // BackBtn
            // 
            ...
            // ServiceTableData
            // 
            ServiceTableData.AllowUserToAddRows = false;
            ServiceTableData.AllowUserToDeleteRows = false;
            ServiceTableData.BackgroundColor = Color.White;
            ServiceTableData.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.DisableResizing;
            ServiceTableData.GridColor = Color.Black;
            ServiceTableData.Location = new Point(40, 80);
            ServiceTableData.Name = "ServiceTableData";
            ServiceTableData.ReadOnly = true;
            ServiceTableData.RowHeadersWidthSizeMode = DataGridViewRowHeadersWidthSizeMode.DisableResizing;
            ServiceTableData.Size = new Size(1145, 432);
            ServiceTableData.TabIndex = 18;
            ServiceTableData.CellContentClick += ServiceTableData_CellContentClick;
            // 
            // ListOfService
            // 
            ...
            Controls.Add(ServiceTableData);
            Name = "ListOfService";
            Text = "ListOfService";
            Load += ListOfService_Load;
            ((System.ComponentModel.ISupportInitialize)ServiceTableData).EndInit();
            ResumeLayout(false);
        }
        ...
        private DataGridView ServiceTableData;
    }
}