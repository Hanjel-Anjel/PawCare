namespace PawCare.AdminPanel
{
    partial class AddVetInfo
    {
        ...
        private void InitializeComponent()
        {
            ...
            SpecializationtxtBox = new CuoreUI.Controls.cuiTextBox();
            ...
            EmailtxtBox.Location = new Point(249, 239);
            ...
            EmailtxtBox.Padding = new Padding(15, 15, 15, 0);
            ...
            EmailtxtBox.Size = new Size(308, 45);
            ...
            ContactNumbertxtBox.Location = new Point(249, 148);
            ...
            ContactNumbertxtBox.Padding = new Padding(15, 15, 15, 0);
            ...
            ContactNumbertxtBox.Size = new Size(308, 45);
            ContactNumbertxtBox.TabIndex = 8;
            ...
            cuiLabel2.Content = "Specialization";
            ...
            cuiLabel2.Location = new Point(249, 299);
            ...
            // 
            // SpecializationtxtBox
            // 
            SpecializationtxtBox.BackColor = Color.Transparent;
            SpecializationtxtBox.BackgroundColor = Color.White;
            SpecializationtxtBox.Content = "";
            SpecializationtxtBox.FocusBackgroundColor = Color.White;
            SpecializationtxtBox.FocusImageTint = Color.White;
            SpecializationtxtBox.FocusOutlineColor = Color.FromArgb(255, 106, 0);
            SpecializationtxtBox.Font = new Font("Microsoft Sans Serif", 9.5F, FontStyle.Regular, GraphicsUnit.Point, 0);
            SpecializationtxtBox.ForeColor = Color.Gray;
            SpecializationtxtBox.Image = null;
            SpecializationtxtBox.ImageExpand = new Point(0, 0);
            SpecializationtxtBox.ImageOffset = new Point(0, 0);
            SpecializationtxtBox.Location = new Point(249, 322);
            SpecializationtxtBox.Margin = new Padding(4, 3, 4, 3);
            SpecializationtxtBox.Multiline = false;
            SpecializationtxtBox.Name = "SpecializationtxtBox";
            SpecializationtxtBox.NormalImageTint = Color.White;
            SpecializationtxtBox.OutlineColor = Color.Black;
            SpecializationtxtBox.Padding = new Padding(15, 15, 15, 0);
            SpecializationtxtBox.PasswordChar = false;
            SpecializationtxtBox.PlaceholderColor = SystemColors.WindowText;
            SpecializationtxtBox.PlaceholderText = "";
            SpecializationtxtBox.Rounding = new Padding(8);
            SpecializationtxtBox.Size = new Size(308, 45);
            SpecializationtxtBox.TabIndex = 12;
            SpecializationtxtBox.TextOffset = new Size(0, 0);
            SpecializationtxtBox.UnderlinedStyle = false;
            SpecializationtxtBox.ContentChanged += SpecializationtxtBox_ContentChanged;
            // 
            // CustomerNameLabel
            // 
            CustomerNameLabel.BackColor = Color.Transparent;
            CustomerNameLabel.Content = "Veterinarian\\ Info";
            ...
            SaveBtn.Location = new Point(417, 388);
            ...
            BackBtn.Location = new Point(249, 388);
            ...
            Controls.Add(SpecializationtxtBox);
        ...
        private CuoreUI.Controls.cuiTextBox SpecializationtxtBox;
